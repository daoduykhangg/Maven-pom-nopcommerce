...
//	@Test(dependsOnMethods = { "TC_01_Add_Product_To_Shopping_Card", "TC_02_Edit_Product_In_Shopping_Card" })
	public void TC_03_Remove_Product_From_Shopping_Card() {
		...
		shoppingCardPage.clickToRemoveCheckbox(driver, UserData.BuildYourOwnComputer.SKU, UserData.BuildYourOwnComputer.IMAGE, UserData.BuildYourOwnComputer.PRODUCT_NAME, UserData.EditBuildYourOwnComputer.EDIT_PRICE, UserData.EditBuildYourOwnComputer.EDIT_PRODUCT_QUANTITY, UserData.EditBuildYourOwnComputer.EDIT_SUB_TOTALS);
		...
		verifyTrue(shoppingCardPage.areProductDetailUnDisplayed(driver, UserData.BuildYourOwnComputer.SKU, UserData.BuildYourOwnComputer.IMAGE, UserData.BuildYourOwnComputer.PRODUCT_NAME, UserData.EditBuildYourOwnComputer.EDIT_PRICE, UserData.EditBuildYourOwnComputer.EDIT_PRODUCT_QUANTITY, UserData.EditBuildYourOwnComputer.EDIT_SUB_TOTALS));
	}
...
//	@Test(dependsOnMethods = { "TC_01_Add_Product_To_Shopping_Card", "TC_02_Edit_Product_In_Shopping_Card", "TC_03_Remove_Product_From_Shopping_Card" })
	public void TC_04_Update_Shopping_Card() {
		...
		verifyTrue(shoppingCardPage.areProductDetailDisplayed(driver, UserData.LenovoIdeaCentre600AllinOnePC.SKU, UserData.LenovoIdeaCentre600AllinOnePC.IMAGE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_NAME, UserData.LenovoIdeaCentre600AllinOnePC.PRICE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_QUANTITY, UserData.LenovoIdeaCentre600AllinOnePC.SUB_TOTALS));

		log.info("Order [Update Card] - Step 10: Enter to 'Qty' Texbox");
		shoppingCardPage.enterToQtyTextboxInTable(driver, UserData.LenovoIdeaCentre600AllinOnePC.SKU, UserData.LenovoIdeaCentre600AllinOnePC.IMAGE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_NAME, UserData.LenovoIdeaCentre600AllinOnePC.PRICE, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_PRODUCT_QUANTITY);
		...
		verifyTrue(shoppingCardPage.areProductDetailDisplayed(driver, UserData.LenovoIdeaCentre600AllinOnePC.SKU, UserData.LenovoIdeaCentre600AllinOnePC.IMAGE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_NAME, UserData.LenovoIdeaCentre600AllinOnePC.PRICE, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_PRODUCT_QUANTITY, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_SUB_TOTALS));

		log.info("Order [Update Card] - Step 14: Check to 'Remove' Checkbox");
		shoppingCardPage.clickToRemoveCheckbox(driver, UserData.LenovoIdeaCentre600AllinOnePC.SKU, UserData.LenovoIdeaCentre600AllinOnePC.IMAGE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_NAME, UserData.LenovoIdeaCentre600AllinOnePC.PRICE, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_PRODUCT_QUANTITY, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_SUB_TOTALS);
		...
		verifyTrue(shoppingCardPage.areProductDetailUnDisplayed(driver, UserData.LenovoIdeaCentre600AllinOnePC.SKU, UserData.LenovoIdeaCentre600AllinOnePC.IMAGE, UserData.LenovoIdeaCentre600AllinOnePC.PRODUCT_NAME, UserData.LenovoIdeaCentre600AllinOnePC.PRICE, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_PRODUCT_QUANTITY, UserData.EditLenovoIdeaCentre600AllinOnePC.EDIT_SUB_TOTALS));
	}
	...
	public void TC_05_Order_Checkout_Products_Payment_By_Cheque() {
		...
		log.info("Order [Payment By Cheque] - Step 45: Verify 'card-totals' is displayed At Confirm Order Step");
		verifyTrue(checkoutPage.areProductDetailDisplayedAtConfirmOrderStep(driver, UserData.AppleMacBookPro13inch.SKU, UserData.AppleMacBookPro13inch.IMAGE, UserData.AppleMacBookPro13inch.PRODUCT_NAME, UserData.AppleMacBookPro13inch.PRICE, UserData.AppleMacBookPro13inch.PRODUCT_QUANTITY, UserData.AppleMacBookPro13inch.SUB_TOTALS));
		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("order-subtotal"), "$3,600.00");
		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("shipping-cost"), "$0.00");
		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("tax-value"), "$0.00");
		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("order-total"), "$3,600.00");
		
		
		log.info("Order [Payment By Cheque] - Step 46: Click to 'Confirm' Button At Comfirm Order Step");
		checkoutPage.clickToConfirmButtonAtConfirmOrderStep();
		
		log.info("Order [Payment By Cheque] - Step 47: Verify Success Message 'Your order has been successfully processed!' is displayed");
		verifyEquals(checkoutPage.getSuccessMessageOrderCompleted(), "Your order has been successfully processed!");
		
		log.info("Order [Payment By Cheque] - Step 48: Verify 'Order Number' Text is displayed");
		String orderNumber = checkoutPage.getTextOrderNumber().replace("ORDER NUMBER: ", "");
		verifyTrue(checkoutPage.isOrderNumberDisplayed());
		
		log.info("Order [Payment By Cheque] - Step 49: click to 'My Account' Link");
		checkoutPage.clickToLinkByClass(driver, "ico-account");
		
		log.info("Order [Payment By Cheque] - Step 50: click to 'Orders' Link");
		checkoutPage.clickToLinkWithPageName(driver, "Orders");
		ordersPage = PageGeneratorManager.getUserOrdersPage(driver);
		
		log.info("Order [Payment By Cheque] - Step 51: Verify 'Order Number' Text is displayed with value '"+ orderNumber +"'");
		verifyEquals(ordersPage.getTextOrderNumber(), "Order Number: " + orderNumber);
		
		log.info("Order [Payment By Cheque] - Step 52: Click to 'Details' Link at 'Orders' Page");
		ordersPage.clickToDetalsButton(orderNumber);
		
		log.info("Order [Payment By Cheque] - Step 53: Verify 'OrderNumber' is displayed");
		verifyEquals(ordersPage.getTextOrderNumberAtOrdersdetail(), "ORDER #"+ orderNumber);
		
//		log.info("Order [Payment By Cheque] - Step 54: Verify 'OrderDate' is displayed");
//		verifyEquals(ordersPage.getTextOrderDate(), "");
		
		log.info("Order [Payment By Cheque] - Step 55: Verify 'OrderSatus' is displayed");
		verifyEquals(ordersPage.getTextOrderStatus(), "Order Status: Pending");
		
		log.info("Order [Payment By Cheque] - Step 56: Verify 'OrderTotal' is displayed");
		verifyEquals(ordersPage.getTextOrderTotal(), "Order Total: $3,600.00");
		
		log.info("Order [Payment By Cheque] - Step 57: Verify Order Information is displayed correctly at 'Orders' Page");
		...
		log.info("Order [Payment By Cheque] - Step 58: Verify 'Gift Wrapping: No' Text is displayed");
		verifyEquals(checkoutPage.getTextGiftWarppingAtConfirmOrderStep(), "Gift wrapping: No");
		
		log.info("Order [Payment By Cheque] - Step 59: Verify Verify 'card-totals' is displayed at 'Orders' Page");
		...
		verifyEquals(ordersPage.getTextCartTotalAtordersPage("1"), "$3,600.00");
		verifyEquals(ordersPage.getTextCartTotalAtordersPage("2"), "$0.00");
		verifyEquals(ordersPage.getTextCartTotalAtordersPage("3"), "$0.00");
		verifyEquals(ordersPage.getTextCartTotalAtordersPage("4"), "$3,600.00");
...
//		log.info("Order [Payment By Card] - Step 40: Click to 'Countinue' Button At Payment method Step");
//		checkoutPage.clickToCountinueButton("payment-method-buttons-container", "payment-method-please-wait");
//		
//		log.info("Order [Payment By Card] - Step 41: Verify Payment Information is displayed At Payment information Step");
//		verifyEquals(checkoutPage.getTextPaymentInforAtPaymentInforStep("1"), "Mail Personal or Business Check, Cashier's Check or money order to:");
//		verifyEquals(checkoutPage.getTextPaymentInforAtPaymentInforStep("2"), "NOP SOLUTIONS" + "\n" + "your address here," + "\n" + "New York, NY 10001" + "\n" + "USA");
//		verifyEquals(checkoutPage.getTextPaymentInforAtPaymentInforStep("3"), "Notice that if you pay by Personal or Business Check, your order may be held for up to 10 days after we receive your check to allow enough time for the check to clear. If you want us to ship faster upon receipt of your payment, then we recommend your send a money order or Cashier's check.");
//		verifyEquals(checkoutPage.getTextPaymentInforAtPaymentInforStep("4"), "P.S. You can edit this text from admin panel.");
//		
//		log.info("Order [Payment By Card] - Step 42: Click to 'Countinue' Button At Payment information Step");
//		checkoutPage.clickToCountinueButton("payment-info-buttons-container", "payment-info-please-wait");
//		
//		log.info("Order [Payment By Card] - Step 43: Verify Order Information is displayed At Confirm Order Step");
//		verifyEquals(checkoutPage.getTextOrderInforAtConfirmOrderStep("Billing Address", "name"), firstName + " " + lastName);
//		verifyEquals(checkoutPage.getTextOrderInforAtConfirmOrderStep("Billing Address", "email"), "Email: " + email);
//		verifyEquals(checkoutPage.getTextOrderInforAtConfirmOrderStep("Billing Address", "phone"), "Phone: " + billPhoneNumber);
//		verifyEquals(checkoutPage.getTextOrderInforAtConfirmOrderStep("Billing Address", "fax"), "Fax:");
...
//		verifyEquals(checkoutPage.getTextOrderInforAtConfirmOrderStep("Shipping", "shipping-method"), "Shipping Method: Ground");
//		
//		log.info("Order [Payment By Card] - Step 44: Verify 'Gift Wrapping: No' Text is displayed");
//		verifyEquals(checkoutPage.getTextGiftWarppingAtConfirmOrderStep(), "Gift wrapping: No");
//		
//		log.info("Order [Payment By Card] - Step 45: Verify 'card-totals' is displayed At Confirm Order Step");
//		verifyTrue(checkoutPage.areProductDetailDisplayedAtConfirmOrderStep(driver, UserData.AppleMacBookPro13inch.SKU, UserData.AppleMacBookPro13inch.IMAGE, UserData.AppleMacBookPro13inch.PRODUCT_NAME, UserData.AppleMacBookPro13inch.PRICE, UserData.AppleMacBookPro13inch.PRODUCT_QUANTITY, UserData.AppleMacBookPro13inch.SUB_TOTALS));
//		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("order-subtotal"), "$3,600.00");
//		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("shipping-cost"), "$0.00");
//		verifyEquals(checkoutPage.getTextCartTotalAtConfirmOrderStep("tax-value"), "$0.00");
...
//		
//		
//		log.info("Order [Payment By Card] - Step 46: Click to 'Confirm' Button At Comfirm Order Step");
//		checkoutPage.clickToConfirmButtonAtConfirmOrderStep();
//		
//		log.info("Order [Payment By Card] - Step 47: Verify Success Message 'Your order has been successfully processed!' is displayed");
//		verifyEquals(checkoutPage.getSuccessMessageOrderCompleted(), "Your order has been successfully processed!");
//		
//		log.info("Order [Payment By Card] - Step 48: Verify 'Order Number' Text is displayed");
//		String orderNumber = checkoutPage.getTextOrderNumber().replace("ORDER NUMBER: ", "");
//		verifyTrue(checkoutPage.isOrderNumberDisplayed());
//		
//		log.info("Order [Payment By Card] - Step 49: click to 'My Account' Link");
//		checkoutPage.clickToLinkByClass(driver, "ico-account");
//		
//		log.info("Order [Payment By Card] - Step 50: click to 'Orders' Link");
//		checkoutPage.clickToLinkWithPageName(driver, "Orders");
//		ordersPage = PageGeneratorManager.getUserOrdersPage(driver);
//		
//		log.info("Order [Payment By Card] - Step 51: Verify 'Order Number' Text is displayed with value '"+ orderNumber +"'");
//		verifyEquals(ordersPage.getTextOrderNumber(), "Order Number: " + orderNumber);
//		
//		log.info("Order [Payment By Card] - Step 52: Click to 'Details' Link at 'Orders' Page");
//		ordersPage.clickToDetalsButton(orderNumber);
//		
//		log.info("Order [Payment By Card] - Step 53: Verify 'OrderNumber' is displayed");
//		verifyEquals(ordersPage.getTextOrderNumberAtOrdersdetail(), "ORDER #"+ orderNumber);
//		
////		log.info("Order [Payment By Card] - Step 54: Verify 'OrderDate' is displayed");
////		verifyEquals(ordersPage.getTextOrderDate(), "");
//		
//		log.info("Order [Payment By Card] - Step 55: Verify 'OrderSatus' is displayed");
//		verifyEquals(ordersPage.getTextOrderStatus(), "Order Status: Pending");
//		
//		log.info("Order [Payment By Card] - Step 56: Verify 'OrderTotal' is displayed");
//		verifyEquals(ordersPage.getTextOrderTotal(), "Order Total: $3,600.00");
//		
//		log.info("Order [Payment By Card] - Step 57: Verify Order Information is displayed correctly at 'Orders' Page");
//		verifyEquals(ordersPage.getTextOrderInforAtordersPage("Billing Address", "name"), firstName + " " + lastName);
//		verifyEquals(ordersPage.getTextOrderInforAtordersPage("Billing Address", "email"), "Email: " + email);
//		verifyEquals(ordersPage.getTextOrderInforAtordersPage("Billing Address", "phone"), "Phone: " + billPhoneNumber);
//		verifyEquals(ordersPage.getTextOrderInforAtordersPage("Billing Address", "fax"), "Fax:");
...
//		verifyEquals(ordersPage.getTextOrderInforAtordersPage("Shipping", "shipping-status"), "Shipping Status: Not yet shipped");
//		
//		log.info("Order [Payment By Card] - Step 58: Verify 'Gift Wrapping: No' Text is displayed");
//		verifyEquals(checkoutPage.getTextGiftWarppingAtConfirmOrderStep(), "Gift wrapping: No");
//		
//		log.info("Order [Payment By Card] - Step 59: Verify Verify 'card-totals' is displayed at 'Orders' Page");
//		verifyTrue(ordersPage.areProductDetailDisplayedAtordersPage(driver, UserData.AppleMacBookPro13inch.SKU, UserData.AppleMacBookPro13inch.PRODUCT_NAME, UserData.AppleMacBookPro13inch.PRICE, UserData.AppleMacBookPro13inch.PRODUCT_QUANTITY, UserData.AppleMacBookPro13inch.SUB_TOTALS));
//		verifyEquals(ordersPage.getTextCartTotalAtordersPage("1"), "$3,600.00");
//		verifyEquals(ordersPage.getTextCartTotalAtordersPage("2"), "$0.00");
//		verifyEquals(ordersPage.getTextCartTotalAtordersPage("3"), "$0.00");
