...
//		System.out.println("End time for wait invisible = " + new Date().toString());
	...
	public void clickToLinkByClass(WebDriver driver, String className) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_CLASS, className);
		clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_CLASS, className);
	}

	public void WaitForLoadingIconInvisibleAtAdmin(WebDriver driver) {
		waitForElementInvisible(driver, NopcommerceAbstractPageUI.LOADING_ICON_AT_ADMIN);
	}
	...
	public void openMenuPageMenuByNameAtHeaderMenu(WebDriver driver, String productPage) {
	...
	public void refreshCurrentPageNopcommerce(WebDriver driver) {
		driver.navigate().refresh();
	...
	public void clickToLinkByNameInFooter(WebDriver driver, String pageName) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_NAME_IN_FOOTER, pageName);
		clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_NAME_IN_FOOTER, pageName);
	}

	public void openSubMenuPageByNameAtHeaderMenu(WebDriver driver, String MenuPageName, String SubMenuPageName) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_MENU_PAGE_BY_NAME_AT_HEADER_MENU, MenuPageName);
		hoverMouseToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_MENU_PAGE_BY_NAME_AT_HEADER_MENU, MenuPageName);
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_MENU_PAGE_BY_NAME_AT_HEADER_MENU, SubMenuPageName);
		clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_MENU_PAGE_BY_NAME_AT_HEADER_MENU, SubMenuPageName);
	}

	public void clickToItemLinkByProductName(WebDriver driver, String productName) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
		clickToElement(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
	}

	public void WaitForLoadingIconInvisibleAtUser(WebDriver driver) {
		waitForElementInvisible(driver, NopcommerceAbstractPageUI.LOADING_ICON_AT_USER);
	}

	public void waitForTextContentInvisible(WebDriver driver) {
		waitForElementInvisible(driver, NopcommerceAbstractPageUI.CONTENT_DIALOG);
	}

	public String getTextContentDialog(WebDriver driver) {
		waitForAllElementVisible(driver, NopcommerceAbstractPageUI.CONTENT_DIALOG);
		return getTextElement(driver, NopcommerceAbstractPageUI.CONTENT_DIALOG);
	}

	public boolean areProductDetailDisplayed(WebDriver driver, String skuValue, String imageValue, String productName, String price, String qtyValue, String total) {
		waitForElementVisible(driver, NopcommerceAbstractPageUI.DYNAMIC_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
		return isElementDisplayed(driver, NopcommerceAbstractPageUI.DYNAMIC_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
	}

	public boolean areProductDetailUnDisplayed(WebDriver driver, String skuValue, String imageValue, String productName, String price, String qtyValue, String total) {
		waitForElementInvisible(driver, NopcommerceAbstractPageUI.DYNAMIC_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
		return isElementUndisplayed(driver, NopcommerceAbstractPageUI.DYNAMIC_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
	}

	public void clickToRemoveCheckbox(WebDriver driver, String skuValue, String imageValue, String productName, String price, String qtyValue, String total) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_REMOVE_CHECKBOX_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
		checkTheCheckbox(driver, NopcommerceAbstractPageUI.DYNAMIC_REMOVE_CHECKBOX_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price, qtyValue, total);
	}

	public void clickToEditLink(WebDriver driver, String skuValue, String imageValue, String productName, String price) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_EDIT_LINK_IN_PRODUCT_COL, skuValue, imageValue, productName, price);
		clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_EDIT_LINK_IN_PRODUCT_COL, skuValue, imageValue, productName, price);
	}

	public void enterToQtyTextboxInTable(WebDriver driver, String skuValue, String imageValue, String productName, String price, String newQtyValue) {
		waitForElementVisible(driver, NopcommerceAbstractPageUI.DYNAMIC_QTY_CHECKBOX_PRODUCT_DETAIL_IN_TABLE, skuValue, imageValue, productName, price);
		sendkeyToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_QTY_CHECKBOX_PRODUCT_DETAIL_IN_TABLE, newQtyValue, skuValue, imageValue, productName, price);
	}
	
	public String getTextNoticeMessage(WebDriver driver) {
		waitForAllElementVisible(driver, NopcommerceAbstractPageUI.THE_WISHLIST_IS_EMPTY_TEXT);
		return getTextElement(driver, NopcommerceAbstractPageUI.THE_WISHLIST_IS_EMPTY_TEXT);
	}

	public void clickToAddToCompareListButton(WebDriver driver, String productName) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_ADD_TO_COMPARE_LIST_BY_PRODUCT_NAME, productName);
		clickToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_ADD_TO_COMPARE_LIST_BY_PRODUCT_NAME, productName);
	}

	public boolean areProductsDisplayed(WebDriver driver, String productName) {
		waitForElementVisible(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
		return isElementDisplayed(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
	}

	public boolean areProductsUndisplayed(WebDriver driver, String productName) {
		waitForElementInvisible(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
		return isElementUndisplayed(driver, NopcommerceAbstractPageUI.ITEM_LINK_BY_PRODUCT_NAME, productName);
	}

	public void hoverToShoppingCardLink(WebDriver driver, String className) {
		waitForElementClickable(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_CLASS, className);
		hoverMouseToElement(driver, NopcommerceAbstractPageUI.DYNAMIC_LINK_BY_CLASS, className);
	}
